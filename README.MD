...
java -jar target/keeply-agent-*.jar
...
* `KEEP_REPO_PATH` – diretórios protegidos.
* `KEEP_DB_URL`, `KEEP_DB_USER`, `KEEP_DB_PASSWORD`.
* `KEEP_S3_BUCKET`, `KEEP_S3_REGION`.
* `KEEP_CHUNK_SIZE_MB`, `KEEP_COMPRESSION_LEVEL`.
